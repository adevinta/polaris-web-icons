...
export const CircleCheckOutline = React.forwardRef(
  (
...
CircleCheckOutline.displayName = 'CircleCheckOutline'

export const tags = ['CircleCheckOutline', '']
