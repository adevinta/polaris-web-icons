...
export const LightningOutline = React.forwardRef(
  (
...
LightningOutline.displayName = 'LightningOutline'

export const tags = ['LightningOutline', '']
