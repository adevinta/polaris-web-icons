...
export const NeutralFaceOutline = React.forwardRef(
  (
...
NeutralFaceOutline.displayName = 'NeutralFaceOutline'

export const tags = ['NeutralFaceOutline', '']
