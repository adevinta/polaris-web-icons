...
export const ChevronHorizontalDown = React.forwardRef(
  (
    ...
    <svg
      ref={ref}
      viewBox="0 0 24 24"
      data-title="ChevronHorizontalDown"
...
ChevronHorizontalDown.displayName = 'ChevronHorizontalDown'

export const tags = ['ChevronHorizontalDown', '']
