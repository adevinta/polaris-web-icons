...
export const WarningShieldFill = React.forwardRef(
  (
...
WarningShieldFill.displayName = 'WarningShieldFill'

export const tags = ['WarningShieldFill', '']
