...
export const ChevronHorizontalUp = React.forwardRef(
  (
    ...
    <svg
      ref={ref}
      viewBox="0 0 24 24"
      data-title="ChevronHorizontalUp"
...
ChevronHorizontalUp.displayName = 'ChevronHorizontalUp'

export const tags = ['ChevronHorizontalUp', '']
