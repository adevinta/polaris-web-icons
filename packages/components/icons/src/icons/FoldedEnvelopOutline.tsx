...
export const FoldedEnvelopOutline = React.forwardRef(
  (
    ...
    <svg
      ref={ref}
      viewBox="0 0 24 24"
      data-title="FoldedEnvelopOutline"
...
FoldedEnvelopOutline.displayName = 'FoldedEnvelopOutline'

export const tags = ['FoldedEnvelopOutline', '']
