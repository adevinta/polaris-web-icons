...
export const FoldedEnvelopFill = React.forwardRef(
  (
...
FoldedEnvelopFill.displayName = 'FoldedEnvelopFill'

export const tags = ['FoldedEnvelopFill', '']
